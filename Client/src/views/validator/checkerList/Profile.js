...
const UserProfile = () => {
  ...
  const approveUser = () => {
    setShowLoader(true);
    let params = { user_id: parseInt(id) };
    callApi("post", ApiConstants.admin.approveuser, params, true)
      .then((response) => {
        setShowLoader(false);
        if (response && response.status_code === 200) {
          setIsApproved(true);
  ...
  const onActiveChange = (status) => {
    setShowLoader(true);
    let apiUrl = status
      ? ApiConstants.user.activateuser
      : ApiConstants.user.deactivateuser;
    callApi(
      "post",
      apiUrl,
      {
    ...
    <React.Fragment>
          ...
          <Card>
            <Card.Body>
              <div className="d-flex align-middle">
                <div className="profile-avatr mr-4">
                  {clientInfo?.profile_image ? (
                    <img
                      src={
                        ...
                        "?file_name=" +
                        clientInfo?.profile_image.file_path
                      }
                      alt="user"
                ...
                <div className="d-inline-block">
                  ...
                  {clientInfo?.id && (
                    <p className="m-b-0">
                      ID: VATZ{("000000" + clientInfo?.id).slice(-6)}
                    </p>
                  )}
                  {clientInfo?.client_user.city && (
                    <p className="m-b-0">
                      {clientInfo?.client_user.city},{" "}
                      {clientInfo?.client_user?.region?.name}
                    </p>
                  )}
              ...
              <Row className="profile-personal-info">
                ...
                <Col lg={12} className="mt-4 pl-4">
                  ...
                  <div>
                    {moment(clientInfo?.created_at).format("DD-MM-YYYY")}
                  </div>
                </Col>
                <Col lg={12} className="mt-4 pl-4">
                  ...
                  {clientInfo?.client_user?.landline ? (
                    <div>
                      {clientInfo?.client_user?.l_country_code}{" "}
                      {clientInfo?.client_user?.landline}
                    </div>
                  ) : (
                    "-"
                  ...
                  <Dropdown>
                    ...
                    <Dropdown.Menu className="py-2 payment-plan">
                      ...
                      <Dropdown.Item className="p-0">
                        <div
                          className="option-item"
                          onClick={() => setPlanHistoryModal(true)}>
                          Payment History
                        </div>
                      </Dropdown.Item>
                      {/* <Dropdown.Item className="p-0">
            ...
            <Card.Body className="p-b-0">
              <Row>
                <Col sm={6}>
                  ...
                  {clientInfo?.client_user?.plan_name ? (
                    <div>VATZ - {clientInfo?.client_user?.plan_name}</div>
                  ) : (
                    "-"
                  )}
                </Col>
                <Col sm={6}>
                  ...
                  <div>
                    {clientInfo?.client_user?.payment_currency}{" "}
                    {clientInfo?.client_user?.payment_amount !== null
                      ? clientInfo?.client_user?.payment_amount
                      : "-"}
                  </div>
                </Col>
                <Col sm={6} className="mt-4">
                  ...
                  <div>
                    {clientInfo?.client_user?.to
                      ? moment(clientInfo.client_user.to).format("DD-MM-YYYY")
                      : "-"}
                  </div>
                </Col>
                <Col sm={6} className="mt-4">
                  ...
                  <div
                    className={
                      clientInfo?.client_user?.to &&
                      moment(clientInfo?.client_user?.to).isAfter(moment.now())
                        ? "text-success"
                        : "text-danger"
                    }>
                    {clientInfo?.client_user?.to &&
                ...
                <Col sm={6} className="mt-4">
                  ...
                  <div>
                    {clientInfo?.client_user?.payment_date
                      ? moment(clientInfo.client_user.payment_date).format(
                          "DD-MM-YYYY"
                        )
                      : "-"}
                  </div>
                  ...
                  <Row>
                    <Col sm={5}>
                      <div>
                        ...
                        <div className="mb-1">
                          {clientInfo?.client_user?.vat_period}
                        </div>
                        <div>
                          {clientInfo?.client_user?.from
                            ? moment(clientInfo.client_user.from).format(
                                "DD-MMM"
                              )
                            : ""}
                          {clientInfo?.client_user?.from && <span> to </span>}
                          {clientInfo?.client_user?.to
                            ? moment(clientInfo.client_user.to).format("DD-MMM")
                            : ""}
                        </div>
                      </div>
                    </Col>
                    <Col sm={4}>
                      <div>
                        ...
                        <p>
                          {clientInfo?.client_user?.vat_percentage !== null
                            ? clientInfo?.client_user?.vat_percentage + "%"
                            : "-"}
                        </p>
                      </div>
                    </Col>
                  ...
                  <Row>
                    <Col sm={5}>
                      <div>
                        ...
                        <div className="mb-1">
                          {clientInfo?.client_user?.building_name && (
                            <span>
                              {clientInfo?.client_user?.building_name},{" "}
                            </span>
                          )}
                          {clientInfo?.client_user?.palce && (
                            <span>{clientInfo?.client_user?.palce}, </span>
                          )}
                          {clientInfo?.client_user?.city && (
                            <span>{clientInfo?.client_user?.city}, </span>
                          )}
                          {clientInfo?.client_user?.p_o_box && (
                            <span>{clientInfo?.client_user?.p_o_box}</span>
                          )}
                        </div>
                        {clientInfo?.client_user.country && (
                          <div>
                            {clientInfo?.client_user.region?.name},{" "}
                            {clientInfo?.client_user.country?.name}
                          </div>
                        )}
                      </div>
                    </Col>
                    ...
                    <Col sm={3}>
                      <div>
                        ...
                        <div>
                          {clientInfo?.client_user?.cp_country_code}{" "}
                          {clientInfo?.client_user?.cp_mobile}{" "}
                        </div>
                      </div>
                    </Col>
                  </Row>
                  ...
                  <Row>
                    <Col sm={5} className="mb-3">
                      <div>
                        ...
                        <div>
                          {clientInfo?.client_user?.trade_license_number}
                        </div>
                        {clientInfo &&
                          clientInfo?.client_user?.trade_license_image && (
                            <div className="mt-2">
                              <a
                    ...
                    <Col sm={5} className="mb-3">
                      <div>
                        ...
                        {clientInfo &&
                          clientInfo?.client_user?.tran_certificate_image && (
                            <div className="mt-2">
                              <a
                                target="_blank" rel="noreferrer"
                                href={
                                  ...
                                  "?file_name=" +
                                  clientInfo?.client_user
                                    ?.tran_certificate_image.file_path
                                }>
                                Download
                              </a>
                              <a
                ...
                <Row>
                  {isApproved && (
                    <Col sm={12}>
                      <div className="my-3 d-flex">
                        ...
                        <Switch
                          onChange={() => setStatusConfirm(true)}
                          checked={isActive}
                          onLabel={""}
                          offLabel={""}
                        />
                  ...
                  <Col sm={12}>
                    <Formik
                      ...
                      initialValues={{
                        checker_user_id: clientInfo?.client_user
                          ?.checker_user_id
                          ? clientInfo?.client_user?.checker_user_id
                          : "",
                        vat_period: clientInfo?.client_user?.vat_period
                          ? clientInfo?.client_user?.vat_period
                          : "",
                        vat_percentage: clientInfo?.client_user?.vat_percentage
                          ? clientInfo?.client_user?.vat_percentage?.toString()
                          : "",
                        start_month: clientInfo?.client_user?.start_month
                          ? clientInfo?.client_user?.start_month
                          : "",
                        start_year: clientInfo?.client_user?.start_year
                          ? clientInfo?.client_user?.start_year
                          : "",
                      }}
                          ...
                          {isApproved && (
                            <Row className="mt-3">
                              <Col sm={6} className="mb-3">
                                <Select
                                  className={`w-100 form-control-select ${
                                    errors.checker_user_id && isSubmitted
                                      ? "is-invalid"
                                      : ""
                                  }`}
                                  classNamePrefix="select"
                                  options={checkersList}
                                  value={checkersList.find(
                                    (i) => i.id === values.checker_user_id
                                  )}
                                ...
                                />
                                <ErrorMessage name="checker_user_id">
                                  {(msg) => (
                              ...
                              <Col sm={6} className="mb-3">
                                <Select
                                  className={`w-100 form-control-select ${
                                    errors.vat_period && isSubmitted
                                      ? "is-invalid"
                                      : ""
                                  }`}
                                  classNamePrefix="select"
                                  options={vatPeriods}
                                  value={vatPeriods.find(
                                    (i) => i.value === values.vat_period
                                  )}
                              ...
                              <Col sm={6} className="mb-3">
                                <Select
                                  className={`w-100 form-control-select ${
                                    errors.vat_percentage && isSubmitted
                                      ? "is-invalid"
                                      : ""
                                  }`}
                                  classNamePrefix="select"
                                  ...
                                  isSearchable={false}
                                  value={vatPercentages.find(
                                    (i) => i.value === values.vat_percentage
                                  )}
                                  onChange={(value) => {
                                    let event = {
                                      target: {
                                ...
                                />
                                <ErrorMessage name="vat_percentage">
                                  {(msg) => (
                                    <div className="invalid-feedback">
                                      {msg}
                                    </div>
                              ...
                              <Col sm={3} className="mb-3">
                                <Select
                                  className={`w-100 form-control-select ${
                                    errors.start_month && isSubmitted
                                      ? "is-invalid"
                                      : ""
                                  }`}
                                  classNamePrefix="select"
                                  options={vatMonths}
                                  value={vatMonths.find(
                                    (i) => i.value === values.start_month
                                  )}
      ...
      <Modal
        ...
        <Modal.Body className="p-0">
          ...
          <AddNewPlan
            ...
            onSuccess={getClientData}
            selectedCountry={clientInfo?.client_user?.country}
            userId={id}
            toggleModal={setNewPlanModal}
          />
        </Modal.Body>
      </Modal>
      ...
      <Modal
        ...
        <Modal.Body className="p-0">
          <button
            type="button"
            className="btn-icon btn close-btn"
            onClick={() => setPlanHistoryModal(false)}>
            <i className="feather icon-x-circle"></i>
          </button>
          <PlanHistory
            onShowLoader={setShowLoader}
            userId={id}
            userData={clientInfo}
            toggleModal={setPlanHistoryModal}
          />
        </Modal.Body>
      </Modal>
      ...
      <Modal
        ...
        <Modal.Body>
          <div>
            {isActive && (
              <span>Only active users can login to application. </span>
            )}
            <span>
              Are you sure that to {isActive ? "deactivate" : "activate"} this
              user?
            </span>
          </div>
        </Modal.Body>
