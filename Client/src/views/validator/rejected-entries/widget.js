...
const RejectedEntriesWidget = (props) => {
  ...
  const getData = React.useCallback(() => {
    setShowLoader(true);
    callApi("get", ApiConstants.entry.validatorrejectedlist, { row_count: props.row_count }, true)
      .then((response) => {
        setShowLoader(false);
...
export default RejectedEntriesWidget;
