...
import CheckedEntriesWidget from "../../validator/checked-entries/widget";
import PendingEntriesWidget from "../../validator/pending-entries/widget";
import ApprovedEntriesWidget from "../../validator/approved-entries/widget";
// import RejectedEntriesWidget from "../../validator/rejected-entries/widget";
...
const Dashboard = () => {
	...
	const getsummary = () => {
		setShowLoader(true);
		callApi("get", ApiConstants.validator.dashboardsummary, null, true)
			.then((response) => {
				setShowLoader(false);
	...
	const getRecentTiles = () => {
		setShowLoader(true);
		callApi("get", ApiConstants.validator.dashboardrecenttile, null, true)
			.then((response) => {
				setShowLoader(false);
				if (response && response.status_code === 200) {
	...
	const getWeeklyGraphData = () => {
		setShowLoader(true);
		callApi("get", ApiConstants.validator.validatorlastweeksgraph, null, true)
			.then((response) => {
				setShowLoader(false);
				if (response && response.status_code === 200) {
	...
	const getVatPayableGraphData = () => {
		setShowLoader(true);
		callApi("get", ApiConstants.validator.validatorvatpayablegraph, null, true)
			.then((response) => {
				setShowLoader(false);
				if (response && response.status_code === 200) {
	...
	return (
		<React.Fragment>
			...
			<Row>
				<Col md={6} xl={3}>
					<Link to="/validator/entries/pending-entries">
				...
				<Col md={6} xl={3}>
					<Link to="/validator/entries/checked-entries">
				...
				<Col md={6} xl={3}>
					<Link to="/validator/entries/approved-entries">
				...
				<Col md={12} xl={6} className="dashboard-grid">
					<Card>
						<Card.Header>
							...
							<Link to="/validator/entries/checked-entries" className="view-all">
				...
				<Col md={12} xl={6} className="dashboard-grid">
					<Card>
						<Card.Header>
							...
							<Link to="/validator/entries/pending-entries" className="view-all">
								<i className="feather icon-chevrons-right"></i>
							</Link>
						</Card.Header>
						<Card.Body className="p-2">
				...
				<Col md={12} xl={6} className="dashboard-grid">
					<Card>
						<Card.Header>
							...
							<Link to="/validator/entries/approved-entries" className="view-all">
								<i className="feather icon-chevrons-right"></i>
							</Link>
						</Card.Header>
						<Card.Body className="p-2">
							<ApprovedEntriesWidget row_count={5} />
							<div className="text-right mt-3">
								<Link to="/validator/entries/approved-entries">
									<button className="btn btn-primary btn-sm m-0">View More</button>
								</Link>
				...
				{/* <Col md={12} xl={6} className="dashboard-grid">
					<Card>
						<Card.Header>
							...
							<Link to="/validator/entries/rejected-entries" className="view-all">
								<i className="feather icon-chevrons-right"></i>
							</Link>
						</Card.Header>
						<Card.Body className="p-2">
							...
							<div className="text-right mt-3">
								<Link to="/validator/entries/rejected-entries">
									<button className="btn btn-primary btn-sm m-0">View More</button>
								</Link>
							</div>
						</Card.Body>
